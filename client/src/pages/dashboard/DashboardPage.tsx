...
export default function DashboardPage() {
  ...
  const enrollmentKPIs = data ? [
    { title: 'Enquiries', value: data.kpis.enquiries, icon: Users, color: 'green' as const },
    { title: 'LSQ Enquiries', value: 0, icon: BarChart3, color: 'cyan' as const },
    { title: 'Gross Admission', value: data.kpis.grossAdmission, icon: UserPlus, color: 'blue' as const },
    { title: 'Transfer In', value: data.kpis.transferIn, icon: ArrowRightLeft, color: 'indigo' as const },
    { title: 'Transfer Out', value: data.kpis.transferOut, icon: ArrowRightLeft, color: 'amber' as const },
    { title: 'Quit', value: data.kpis.quit, icon: UserMinus, color: 'red' as const },
  ] : [];

  const financialKPIs = data ? [
    { title: 'Receivable', value: data.financials.receivable, icon: IndianRupee, color: 'blue' as const },
    { title: 'Collection', value: data.financials.collection, icon: Wallet, color: 'green' as const },
    { title: 'Payment Due', value: data.financials.paymentDue, icon: CreditCard, color: 'amber' as const },
    { title: 'FCR Deposited', value: data.financials.fcrDeposited, icon: Receipt, color: 'orange' as const },
    { title: 'FCR Pending', value: data.financials.fcrPending, icon: FileText, color: 'cyan' as const },
    { title: 'Credit Note', value: 0, icon: FileText, color: 'pink' as const },
  ] : [];
